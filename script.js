...
let getCityWeather = function(city) {
    ...
    let apiUrl = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=bf17cff4e387d5594892608f7ffa180a&units=imperial";
...
let displayWeather = function(weatherData) {
    ...
    fetch("https://api.openweathermap.org/data/2.5/uvi?lat=" + weatherData.coord.lat + "&lon="+ weatherData.coord.lon + "&appid=bf17cff4e387d5594892608f7ffa180a")
        .then(function(response) {
            response.json().then(function(data) {
    ...
    // five-day api call
    fetch("https://api.openweathermap.org/data/2.5/forecast?q=" + weatherData.name + "&appid=&units=imperial")
        .then(function(response) {
            response.json().then(function(data) {
